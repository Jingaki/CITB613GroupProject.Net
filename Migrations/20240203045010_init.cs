        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionOfNegotiatedInterestRate = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    MinSum = table.Column<float>(type: "real", nullable: false),
                    MinSumDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    MinDuration = table.Column<int>(type: "int", nullable: false),
                    MaxSum = table.Column<float>(type: "real", nullable: false),
                    MaxSumDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    MaxDuration = table.Column<int>(type: "int", nullable: false),
                    DurationDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearlyEIR = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftingInterests_table", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShiftingInterests_table_Deposits_DepositId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftingInterests_table_DepositId",
                table: "ShiftingInterests_table",
                column: "DepositId");
        }
